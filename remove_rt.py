...
with open(os.path.join(os.path.dirname(__file__), 'traffic-dice-0.8.csv'), 'a', newline='\n') as csv_output:
    csv_writer = csv.writer(csv_output, delimiter=',', quotechar='"', quoting=csv.QUOTE_ALL)
    for tweet in distinct_traffic_tweets:
        csv_writer.writerow(tweet)

with open(os.path.join(os.path.dirname(__file__), 'non_traffic-dice-0.8.csv'), 'a', newline='\n') as csv_output:
    csv_writer = csv.writer(csv_output, delimiter=',', quotechar='"', quoting=csv.QUOTE_ALL)
